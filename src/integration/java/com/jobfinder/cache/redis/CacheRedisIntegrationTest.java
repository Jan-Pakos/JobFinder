package com.jobfinder.cache.redis;
...
class CacheRedisIntegrationTest extends BaseIntegrationTest {
    ...
    public void should_save_offers_to_cache_and_then_invalidate_by_time_to_live() throws Exception {
        ...
        // step 3: fetch offers for the first time
        // given && when
        ...
        assertThat(cacheManager.getCacheNames().contains("allJobOffers")).isTrue();

        // step 4: fetch offers second time after cache should expire
        // given && when && then
        await()
